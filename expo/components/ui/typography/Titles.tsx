 ...
 */
export const H1: React.FC<TypographyComponentProps> = ({
  children,
  style,
}: TypographyComponentProps): React.ReactElement => {
 ...
 */
export const H2: React.FC<TypographyComponentProps> = ({
  children,
  style,
}: TypographyComponentProps): React.ReactElement => {
 ...
 */
export const H3: React.FC<TypographyComponentProps> = ({
  children,
  style,
}: TypographyComponentProps): React.ReactElement => {
 ...
 */
export const H4: React.FC<TypographyComponentProps> = ({
  children,
  style,
}: TypographyComponentProps): React.ReactElement => {
